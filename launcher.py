...
class Migrations:
    def __init__(self, *, filename: str = "migrations/revisions.json"):
        ...
        self.version: int = 0
        self.database_uri: str | None = None
        self.load()
...
async def create_redis_pool() -> redis.Redis:
    ...
    try:
        ...
        raise RuntimeError("Could not connect to Redis. Exiting.")
...
def init():
    ...
    try:
        ...
        click.secho(
            f"Successfully initialized and applied {applied} revisions(s)", fg="green"
        )
